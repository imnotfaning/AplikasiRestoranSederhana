...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Mar 2024 pada 02.09
...
(2, 'Ayam Geprek', 10000, 'Tersedia'),
(6, 'Manggo Sticky Rice', 20000, 'Tersedia');
...
(1, 'Nisa', 1, '2024-01-17', 'Mie Ayam Spesial', 15000, 5, 75000),
(2, 'Jk', 6, '2024-01-11', 'Manggo Sticky Rice', 20000, 2, 40000),
(4, 'Fara', 6, '2024-01-17', 'Manggo Sticky Rice', 20000, 2, 40000);
...
(1, 'Admin', 'admin123', 'Syafara', 1),
(2, 'kasir', 'kasir123', 'Doel', 2),
(3, 'owner', 'owner123', 'fara', 3),
(5, 'Pelanggan', 'qwerty123', 'NCT', 4);
